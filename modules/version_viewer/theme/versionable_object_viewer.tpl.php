...
?>
    <div id="eui_window" class="easyui-layout" style="width:100%;height:550px;">
        ...
        <div id="easy-ui-south" data-options="onBeforeExpand:function(){return false},region:'south',split:true,collapsible:false,minimized:true,border:false" style="height:500px;">
        ...
        <div id="easy-ui-west" data-options="region:'west',split:true,border:false,maximizable:false,closable:false,minimized:<?php print $hide_components['w']; ?>,border:true,collapsible:false" style="width:150px;height:500px;">
