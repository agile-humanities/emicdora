...
<div id="eui_window" class="easyui-layout" style="width:100%;height:729px" data-options="fit:true,maxHeight:700">
        <div id="easy-ui-north" data-options="region:'north',onBeforeExpand:function(){return false}" style="height:50px;">
        ...
        <div id="easy-ui-east" class="easyui-panel" data-options="region:'east',split:true,border:false,collapsible:false"  style="width:200px;">
        ...
        <div id="easy-ui-west" data-options="region:'west',split:true,border:true,minimized:<?php print $hide_components['w']; ?>,collapsed:true" style="width:150px;">
          <div id="uitree-wrapper" class="easyui-panel" data-options="fit:true,border:false" style="width:auto;height:auto;">
              <ul id="easyui_tree" class="easyui-tree" data-options="animate:true,lines:true,border:false,checkbox:true,fit:true">
              </ul>
          </div>
        </div>
